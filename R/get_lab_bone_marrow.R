#' Retrieves the Bone Marrow Laboratory Data
#'
#' `get_lab_bone_marrow()` retrieves bone marrow lab data for a specified period
#' from the KHIS API server.
#'
#' @inheritParams get_analytics_formatted
#'
#' @return A tibble containing bone marrow lab data with the following columns:
#'
...
get_lab_bone_marrow <- function(start_date,
  ...
  data <- get_analytics_formatted(bone_marrow_ids,

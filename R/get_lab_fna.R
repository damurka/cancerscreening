#' Retrieves the Fine-Needle Aspiration Laboratory Data
#'
#' `get_lab_fna()` retrieves fine-needle aspiration lab data for a specified period
#' from the KHIS API server.
#'
#' @inheritParams get_analytics_formatted
#'
#' @return A tibble containing fine-needle aspiration lab data with the following columns:
#'
...
get_lab_fna <- function(start_date,
  ...
  data <- get_analytics_formatted(fna_ids,

---
title: "Cervical Cancer Screening Coverage"
---
...
Coverage refers to the extent of participation of eligible (i.e., target age) women in the screening program in a given time period and is calculated by dividing the number of eligible women screened during a given time by the total number of eligible women. High coverage of the target population is one of the most important components of a successful cervical cancer prevention program (Pretorius et al. 1991, Sasieni 1991, WHO 1992).

## Screening Coverage Calculation
